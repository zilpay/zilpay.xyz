...
Both of these are available synchronously as `window.zilPay.wallet`. You can listen for changes using events, too ([see the observable state](https://zilpay.xyz/Documentation/zilliqa-provider/#window-zilpay-wallet-observablenetwork)).
